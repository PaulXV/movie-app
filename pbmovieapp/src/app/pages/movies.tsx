...
import { getMoviesByBucket } from "../../../services/movieService";
...
export default function Movies() {
  ...
  const inCorso = getMoviesByBucket("inCorso");
  const daVedere = getMoviesByBucket("daVedere");
  const giaViste = getMoviesByBucket("giaViste");
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Tieni traccia di quello che stai guardando, vuoi vedere o hai già
            visto.
          </Text>
        </View>
