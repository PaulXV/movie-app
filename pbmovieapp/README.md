...
PB Movie App is a simple cross-platform tracker for movies and TV shows built with Expo. It is designed to run on Android, iOS, and web from the same codebase.
